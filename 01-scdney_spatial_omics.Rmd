...
for (topgene in topgenes) {
  g_spe = plotReducedDim(spe, "spatialCoords", colour_by = c(topgenes[1]), point_size = 1) +
    coord_fixed()
  g_scHOT = plotReducedDim(scHOT_spatial, "spatialCoords", colour_by = c(topgenes[1]), point_size = 1,
...
# ClassifyR: Classification of IMC data
